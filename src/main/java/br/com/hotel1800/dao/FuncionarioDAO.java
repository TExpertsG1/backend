...
public class FuncionarioDAO {
	...
	public Funcionario buscaPor(String cpf) {
		EntityManager em = JPAFactory.getEntityManager();
		return em.find(Funcionario.class, cpf);

	}

	public void deletar(String funcionario) {
	    EntityManager em = JPAFactory.getEntityManager();
	    em.getTransaction().begin();
	    Funcionario func = em.find(Funcionario.class, funcionario);
	    em.remove(func);
	    em.getTransaction().commit();
	    em.close();
	}
	
	public void update(String funcionario) {
		EntityManager em = JPAFactory.getEntityManager();
	    em.getTransaction().begin();
